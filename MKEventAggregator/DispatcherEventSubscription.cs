...
namespace MKEventAggregator
{
    ...
    public class DispatcherEventSubscription<TPayload> : EventSubscription<TPayload>
    {
        ...
        public DispatcherEventSubscription(IDelegateReference actionReference, IDelegateReference filterReference, SynchronizationContext context, EventCommunicatorAddress subscriberAddress, EventCommunicatorsRelationship acceptFrom)
            : base(actionReference, filterReference, subscriberAddress, acceptFrom)
        {
            syncContext = context;
        }
