...
namespace MKEventAggregator
{
    ...
    public class BackgroundEventSubscription<TPayload> : EventSubscription<TPayload>
    {
        ...
        public BackgroundEventSubscription(IDelegateReference actionReference, IDelegateReference filterReference, EventCommunicatorAddress subscriberAddress, EventCommunicatorsRelationship acceptFrom)
